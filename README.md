...
Using the Plotly's R graphing library, we can transforme the static chart to intercative one [See example](http://najlaksouri.github.io/
R_scripts/PlotlyScatterExample.html). The Plotly.R is free and open source.   
